...
const navItems = [
  { iconName: 'LayoutDashboard', label: 'Audit Dashboard', path: '/' },
  { iconName: 'Scale', label: 'Fairness Metrics', path: '/metrics' },
  { iconName: 'Fingerprint', label: 'Demographic Parity', path: '/parity' },
  { iconName: 'FileBadge', label: 'Compliance Docs', path: '/docs' },
  { iconName: 'ShieldAlert', label: 'Bias Alerts', path: '/alerts' },
];
      ...
      <div className="p-8">
        <div className="flex items-center gap-3 group">
          <div className="w-10 h-10 bg-indigo-600 rounded-xl flex items-center justify-center shadow-lg shadow-indigo-600/20 group-hover:scale-110 transition-transform duration-500">
            <Lucide.Scale className="text-white w-6 h-6" />
          </div>
          <span className="font-bold text-xl tracking-tight text-white font-mono">Sally<span className="text-indigo-500">Fair</span></span>
        </div>
      </div>
