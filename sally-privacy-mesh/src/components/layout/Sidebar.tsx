...
const navItems = [
  { iconName: 'LayoutDashboard', label: 'Privacy Overview', path: '/' },
  { iconName: 'Network', label: 'Inference Mesh', path: '/mesh' },
  { iconName: 'ShieldPlus', label: 'Privacy Budget', path: '/budget' },
  { iconName: 'ScanEye', label: 'Data Leak Audit', path: '/audit' },
  { iconName: 'Settings', label: 'Mesh Config', path: '/settings' },
];
      ...
      <div className="p-8">
        <div className="flex items-center gap-3 group">
          <div className="w-10 h-10 bg-indigo-600 rounded-xl flex items-center justify-center shadow-lg shadow-indigo-600/20 group-hover:scale-110 transition-transform duration-500">
            <Lucide.ZapOff className="text-white w-6 h-6" />
          </div>
          <span className="font-bold text-xl tracking-tight text-white font-mono">Sally<span className="text-indigo-500">Privacy</span></span>
        </div>
      </div>
